...
namespace Fashion.Infrastructure.Migrations
{
    ...
    [Migration("20250713112641_updateManager&Admin")]
    partial class updateManagerAdmin
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fashion.Core.Entities.FittingRoom", b =>
                {
                    b.HasOne("Fashion.Core.Entities.Item", "CurrentItem")
                        .WithMany()
                        .HasForeignKey("CurrentItemId");

                    b.HasOne("Fashion.Core.Entities.User", "CurrentUser")
                        .WithMany()
