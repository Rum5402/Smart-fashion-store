...
{
    /// <inheritdoc />
    public partial class InnitiCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsNewCollection = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StaffMessage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FittingRoomRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FittingRoomRequests_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FittingRoomRequests_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSavedItems", x => new { x.SavedByUsersId, x.SavedItemsId });
                    table.ForeignKey(
                        name: "FK_UserSavedItems_Items_SavedItemsId",
                        column: x => x.SavedItemsId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSavedItems_Users_SavedByUsersId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FittingRoomRequestId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_FittingRoomRequests_FittingRoomRequestId",
                        column: x => x.FittingRoomRequestId,
                        principalTable: "FittingRoomRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FittingRoomRequests_ItemId",
                table: "FittingRoomRequests",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_FittingRoomRequests_UserId",
                table: "FittingRoomRequests",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_FittingRoomRequestId",
                table: "Notifications",
                column: "FittingRoomRequestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSavedItems_SavedItemsId",
